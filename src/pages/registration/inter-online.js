...
export default function InternationalOnline() {
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbzy-BGQahMwqtrbCResosmJlYxSz8Ag4TbbYnOS-AtXnThcWRcvfkwW4q6SJIoAHdkHFA/exec";
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="International Young Moslem Inventor Award - Online Competition">
                      Online Competition
                    </option>
                    <option value="International Young Moslem Inventor Award - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="International Young Moslem Inventor Award - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
