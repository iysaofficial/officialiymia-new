...
export default function InternationalOffline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "International Young Moslem Inventor Award - Offline Competition":
        break;
      case "International Young Moslem Inventor Award - Offline Competition + Full Package":
        break;
      case "International Young Moslem Inventor Award - Offline Competition + Excursion":
        break;
      default:
        setCategoryPrice("");
        break;
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbw-U6Vblpb-f5OC0fPvjQq_kg0TRpDuHtUlRuqWxxntRBiFXgH4S8F77wMzCVqU4k7v6w/exec";
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="International Young Moslem Inventor Award - Offline Competition">
                      Offline Competition
                    </option>
                    <option value="International Young Moslem Inventor Award - Offline Competition + Full Package">
                      Offline Competition + Full Package
                    </option>
                    <option value="International Young Moslem Inventor Award - Offline Competition + Excursion">
